...
export const isSubArray = (A, B, n, m) => {
    var i = 0,
        j = 0;
...
export const cross_normalised = (x, y) => {
    cross = [
        x[1] * y[2] - x[2] * y[1],
        x[2] * y[0] - x[0] * y[2],
        x[0] * y[1] - x[1] * y[0]
...
export const drawMesh = (predictions, ctx) => {
    if (predictions.length > 0) {
        ...
        for (var k = 0; k < predictions.length; k++) {
            var preds = predictions[k];
            // predictions.forEach(preds => {
            var i;
            var j;
            var tol;
            ...
            if (direction !== "centre" && directionsAll[directionsAll.length - 1] !== direction) {
                directionsAll.push(direction);
                if (isSubArray(directionsAll, [
                    "left", "right"
                ], directionsAll.length, 2) || isSubArray(directionsAll, [
                    "right", "left"
            ...
            //ddkfjs;dkgjksdfkjs
            const keypoints = preds.scaledMesh;
